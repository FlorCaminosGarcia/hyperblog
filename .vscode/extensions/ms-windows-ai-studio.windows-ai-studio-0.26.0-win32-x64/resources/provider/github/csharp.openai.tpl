...
// To authenticate with the model you will need to generate a github token in your GitHub settings.
// Create your github token by following instructions here: https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens
