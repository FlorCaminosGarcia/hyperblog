...
<socratic_tutor>
<inner_monologue> First, I will solve the problem myself, thinking step by step.
-4(2 - x) = 8
2 - x = -2
x = 4
...
Have you double-checked that you multiplied each term by negative 4 correctly?</socratic_tutor>
...
Great job correcting your mistake. What do you think you should do next?</socratic_tutor>
<student> I don't know, do you have any suggestions?</student>
<socratic_tutor>
<inner_monologue>
Give the student a small hint to help them solve the problem.
</inner_monologue>
Why don't you see if you can get X by itself?</socratic_tutor>
...
Hmm, did you really subtract 8 from both sides?</socratic_tutor>
...
Wonderful job! That's exactly right.</socratic_tutor>
</example>
<example>
<student> I'm trying to find an equation that will go through the points ( 3, 8 ) and ( 1, 2 ). Can you please help me?</student>
<socratic_tutor>
<inner_monologue> To find the equation that goes through the points (3,8) and (1,2), I will use the point slope formula:
y - y1 = m(x - x1)
...
As a next step, think about how you can calculate the slope between those two points. That will help you determine the equation. </socratic_tutor>
...
Are you sure you've calculated the slope correctly? Remember, rise over run = (y2 - y1) / (x2 - x1) </socratic_tutor>
...
y - 8 = 3x - 9
y = 3x - 1
The original solution I calculated was also y = 3x - 1. Therefore the student is on the right track. Give them a hint about what to do next. </inner_monologue>
Good work calculating the slope. Now you can use point-slope form: y - y1 = slope(x - x1). </socratic_tutor>
<student> y - 2 = 3(x - 1)
y - 2 = 3x - 3
y = 3x - 1</student>
<socratic_tutor>
...
y = 3x - 1
My original answer was y = 3x - 1. The two equations match. Compliment the student. </inner_monologue>
Great work! You found the formula. Feel free to double-check to make sure it goes through the other point. </socratic_tutor>
</example>
<example>
<student> Can you help me differentiate f(x) = 3x^2 - 4x + 3? </student>
<socratic_tutor>
<inner_monologue> To differentiate f(x) = 3(x^2) - 4x + 3, I will use the power rule, constant multiple rule, and summation rule: f'(x) = 6x - 4
...
<socratic_tutor>
<inner_monologue> The power rule states that the derivative of x^n is: nx^(n-1) </inner_monologue>
The power rule is:
...
Can you make sure you took the derivative of all the terms? </socratic_tutor>
...
Terrific! You've solved the problem. </socratic_tutor>
...
2. In <instructions_structure> tags, plan out how you will structure your instructions. In particular, plan where you will include each variable -- remember, input variables expected to take on lengthy values should come BEFORE directions on what to do with them.
