...
public class Main {
    ...
    private static final String API_KEY = System.getenv("CUSTOM_OPENAI_API_KEY");
...
{{#isAzureOpenAI}}
            ...
            com.azure.ai.openai.OpenAIClient azureClient = new OpenAIClientBuilder()
                .endpoint(ENDPOINT)
                .credential(new AzureKeyCredential(API_KEY))
                .buildClient();
            
            // Note: Azure OpenAI client integration with OpenAI Java SDK would require additional adapter code
            // For now, fallback to standard OpenAI client with Azure endpoint
...
{{#extraQuery}}
{{#.}}
                    initialParamsBuilder.putAdditionalQueryParam("{{key}}", "{{value}}");
{{/.}}
{{/extraQuery}}
